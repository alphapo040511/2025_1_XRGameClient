...
public class DamageEffectManager : MonoBehaviour
{
    ...
    public void ShowDamageText(Vector3 position, string text, Color color, bool isCritical = false, bool isStatusEffect = false)
    {
        ...
        if (tmp != null)
        {
            ...
            tmp.outlineColor = new Color(                                       //아웃라인 색상 결정
    ...
    public void ShowDamage(Vector3 position, int amount, bool isCritical)                   //데미지 함수
    {
    ...
    public void ShowHeal(Vector3 position, int amount, bool isCritical)                     //힐링함수
    {
        string text = amount.ToString();
